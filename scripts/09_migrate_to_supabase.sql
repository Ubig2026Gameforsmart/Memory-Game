-- Migration script untuk mengganti localStorage dengan Supabase
-- Menambahkan fields dan tabel yang diperlukan
...
-- 6. Buat function untuk cleanup expired sessions
...
-- 11. Update existing data structure
...
-- 12. Update rooms dengan default game state
UPDATE rooms 
