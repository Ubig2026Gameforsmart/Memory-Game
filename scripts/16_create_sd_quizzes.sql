-- Script untuk membuat 10 quiz SD dengan masing-masing 25 soal
-- Kategori: Matematika, IPA, Bahasa Indonesia, IPS, PKN, Seni Budaya, PJOK, Bahasa Inggris, Agama, Teknologi
