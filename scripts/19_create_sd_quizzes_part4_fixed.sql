-- Script untuk memperbaiki tanda kutip tunggal di file 19_create_sd_quizzes_part4.sql
-- Menjalankan perbaikan untuk semua tanda kutip tunggal yang bermasalah

-- Quiz 8: Bahasa Inggris Dasar (DIPERBAIKI)
...
-- Quiz 10: Teknologi Dasar (DIPERBAIKI)
INSERT INTO quizzes (id, title, description, category, questions, created_at, updated_at) VALUES (
  gen_random_uuid(),
